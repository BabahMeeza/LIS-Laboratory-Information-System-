...
final class UnitConverter
{
    ...
    public static function normal(?string $satuan): string
    {
        ...
        $alias = [
            ...
            'cells/ul' => '/ul',
            'sel/ul'   => '/ul',
            // Sedimen urine. HPF (high power field) = LPB (lapang pandang
            // besar); LPF (low power field) = LPK (lapang pandang kecil).
            // HPF dan LPF TIDAK setara satu sama lain — luas lapangnya
            // berbeda — jadi sengaja tidak disamakan.
            '/hpf'     => '/lpb',
            '/[hpf]'   => '/lpb',
            'hpf'      => '/lpb',
            'sel/lpb'  => '/lpb',
