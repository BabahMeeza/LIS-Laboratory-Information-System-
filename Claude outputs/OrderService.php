...
final class OrderService
{
    ...
    {
        $hasil = Database::transaction(static function () use ($data, $testIds, $panelIds): array {
        ...
        // Tabung yang dikerjakan alat SEBELUM ordernya tiba di LIS.
        //
        // Hal ini biasa terjadi: sampel sudah di laboratorium dan diperiksa,
        // sementara order dari Khanza baru ditarik belakangan. Hasilnya
        // tersimpan di Hasil Menggantung dan, sebelumnya, tinggal di sana
        // sampai ada petugas yang memasangkannya satu per satu.
        //
        // Dilakukan SESUDAH transaksi order selesai dan dibungkus sendiri:
        // kegagalan di sini tidak boleh membatalkan order yang sudah sah.
        try {
            ResultProcessor::pasangOtomatisUntukOrder((int) $hasil['order_id']);
        } catch (\Throwable $e) {
            Logger::warning('Pemasangan otomatis hasil menggantung gagal: ' . $e->getMessage(), [
