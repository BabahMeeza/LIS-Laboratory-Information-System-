...
final class KhanzaApi extends ApiController
{
    ...
    public function hasilSiapKirim(): Response
    {
        ...
        $noorder = $this->request->str('noorder');
        ...
        // Permintaan untuk SATU order: saring di sisi server.
        //
        // Tanpa ini, parameter noorder yang dikirim Khanza diabaikan dan
        // endpoint selalu berjalan dalam mode massal — 20 order terlama
        // yang belum terkirim. Order yang diminta bisa berada di luar
        // jendela itu dan tidak akan pernah muncul, berapa kali pun
        // tombolnya ditekan.
        //
        // Syarat "belum pernah terkirim" sengaja DILEPAS di sini: petugas
        // yang menekan tombol memang sedang meminta hasil itu sekarang,
        // termasuk bila sebelumnya sudah pernah diambil.
        if ($noorder !== '') {
            $where = [
                'o.khanza_noorder = ?',
                "o.status IN ('verified','released')",
